        ...
        <form className="flex flex-1 flex-col justify-between" onSubmit={handleSubmit(handleCreateGoal)}>
          <div className="gap-6 flex flex-col flex-1">
            <div className="gap-2 flex flex-col">
              ...
              <Input autoFocus id="title" placeholder="Praticar exercícios, meditar, etc..." {...register('title')} />
              {formState.errors.title && <p className="text-red-300 text-sm">{formState.errors.title.message}</p>}
            </div>
